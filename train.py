...
model = AutoModelForCausalLM.from_pretrained("./qwen/Qwen2-1___5B-Instruct/", torch_dtype=torch.bfloat16)
...
# 设置 MLflow 实验
mlflow.set_experiment("Qwen2-finetune")

# 开始 MLflow run
with mlflow.start_run(run_name="Qwen2-1.5B-Instruct") as run:
    # 记录参数
    mlflow.log_params({
    ...
    mlflow.pytorch.log_model(
        model, 
        "model",
        extra_files=["./qwen/Qwen2-1___5B-Instruct/config.json"]
    )
